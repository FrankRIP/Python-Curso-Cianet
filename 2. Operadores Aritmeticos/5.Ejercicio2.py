...
y muñecas que saldrán en cada paquete a demanda. Cada payaso pesa 112 g y cada muñeca 75 g. Un cliente frecuente 
...
print("EL PESO TOTAL ES DE:", (Pesopayasos * Tpaya) + (Pesomunecas * Tmune), "GRAMOS")


#Otra forma de solucionarlo seria
print ("El PESO TOTAL DEL PEDIDO ES DE:", (23 * 112) + (54 * 75),"Grs.")
